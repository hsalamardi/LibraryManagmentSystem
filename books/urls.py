...
from .theme_views import theme_css, theme_variables_json, clear_theme_cache_view
...
urlpatterns = [
    ...
    path('theme/variables.json', theme_variables_json, name='theme_variables'),
    path('theme/clear-cache/', clear_theme_cache_view, name='clear_theme_cache'),
    
    # Performance and Security Monitoring
    path('monitoring/performance/', monitoring_views.performance_dashboard, name='performance_dashboard'),
    path('monitoring/security/', monitoring_views.security_dashboard, name='security_dashboard'),
    path('monitoring/clear-cache/', monitoring_views.clear_performance_cache, name='clear_performance_cache'),
    path('monitoring/export/', monitoring_views.export_performance_data, name='export_performance_data'),
]